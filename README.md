...
4. If you cant find the ip address of the board, you can download the WLED app to your phone.  There is both an IOS an android version.  The app will poll your home network and find any devices running WLED.  When it finds the board you can connect to it in the app.
